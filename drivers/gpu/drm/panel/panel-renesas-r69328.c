...
static const u8 dx12d100vm0eaa_gamma_setting[] = {
	0x00, 0x1A, 0x20, 0x28, 0x25, 0x24, 0x26, 0x15,
	0x13, 0x11, 0x18, 0x1E, 0x1C, 0x00,
	0x00, 0x1A, 0x20, 0x28, 0x25, 0x24, 0x26, 0x15,
	0x13, 0x11, 0x18, 0x1E, 0x1C, 0x00
};
...
static int renesas_r69328_on(struct renesas_r69328 *ctx)
{
	...
	dsi_generic_write_seq(R69328_GAMMA_SET_A, dx12d100vm0eaa_gamma_setting);
	dsi_generic_write_seq(R69328_GAMMA_SET_B, dx12d100vm0eaa_gamma_setting);
	dsi_generic_write_seq(R69328_GAMMA_SET_C, dx12d100vm0eaa_gamma_setting);
...
static int renesas_r69328_off(struct renesas_r69328 *ctx)
{
	struct mipi_dsi_device *dsi = ctx->dsi;
...
static const struct drm_display_mode renesas_r69328_mode = {
	.clock = (720 + 100 + 4 + 189) * (1280 + 100 + 4 + 189) * 60 / 1000,
	.hdisplay = 720,
	.hsync_start = 720 + 100,
	.hsync_end = 720 + 100 + 4,
	.htotal = 720 + 100 + 4 + 189,
	.vdisplay = 1280,
	.vsync_start = 1280 + 4,
	.vsync_end = 1280 + 4 + 1,
	.vtotal = 1280 + 4 + 1 + 4,
