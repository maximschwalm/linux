...
#define DSI_PAD_CONTROL_PULLDN(x)	(((x) & 0x1) << 28)
#define DSI_PAD_CONTROL_SLEW_UP(x)	(((x) & 0x7) << 24)
#define DSI_PAD_CONTROL_SLEW_DN(x)	(((x) & 0x7) << 20)
#define DSI_PAD_CONTROL_PREEMP_EN(x)	(((x) & 0x1) << 19)
#define DSI_PAD_CONTROL_PDIO_CLK	(1 << 18)
#define DSI_PAD_CONTROL_PDIO(x)		(((x) & 0x3) << 16)
#define DSI_PAD_CONTROL_LP_UP(x)	(((x) & 0x3) << 14)
#define DSI_PAD_CONTROL_LP_DN(x)	(((x) & 0x3) << 12)
